        ...
        orderFichierTransfereAsync: sinon.stub().resolves({
          return: {
            ...
            codes: {
              ...
              item: [
                {
                  key: { attributes: { 'xsi:type': 'xsd:int' }, $value: '5591277' },
                  value: {
                    attributes: { 'xsi:type': 'SOAP-ENC:Struct' },
                    code: { attributes: { 'xsi:type': 'xsd:int' }, $value: '0' },
                    success: { attributes: { 'xsi:type': 'xsd:boolean' }, $value: 'true' },
                    errorList: {
                      attributes: {
                ...
                {
                  key: { attributes: { 'xsi:type': 'xsd:int' }, $value: '5591389' },
                  value: {
                    attributes: { 'xsi:type': 'SOAP-ENC:Struct' },
                    code: { attributes: { 'xsi:type': 'xsd:int' }, $value: '0' },
                    success: { attributes: { 'xsi:type': 'xsd:boolean' }, $value: 'true' },
