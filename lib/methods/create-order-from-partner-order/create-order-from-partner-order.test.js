...
} = require('../create-order/create-order.test');
...
describe('create-order-from-partner-order', () => {
  describe('createOrderFromPartnerOrder()', () => {
    const createOrderFromPartnerOrder = createOrderFromPartnerOrderFactory(
      clientStub
    );
    ...
    it('should create an order and return result', () => {
      ...
      const createOrderFromPartnerOrderPromise = createOrderFromPartnerOrder(
        request
      );
